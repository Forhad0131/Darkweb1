...
os.system('xdg-open https://www.facebook.com/forhadhosen35136?mibextid=JRoKGipl')
...
def public():
        ...
        linex()
        print(' [1] Method 1 (for mixed ids) \n')
        linex()
        mthd = input(' Choose method: ')
        linex()
        print(' Do you went show cp/ok account? (1): ')
        linex()
        cx=input(' Choose: ')
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' [1] File cloning\y [2] Create ids file\y [3] Public cloning\y [4] Random number cloning\y [5] Random gmail crack\y [6] Download Vpn\y [7] How To Use Video\y [0] Exit menu')
                        linex()
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801315931861&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi FORHAD Sir, I Need To Buy Your Paid SHAMI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python DARK-WEB.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def gmail():
                ...
                with tred(max_workers=30) as FORHAD:
                        total = str(len(fo))
                        clear()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [FORHAD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
